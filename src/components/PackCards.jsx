    ...
    <img
      ...
      className="absolute bottom-0 p-4 flex justify-start w-full h-full flex-col bg-[rgba(0,0,0,0.5)] rounded-[24px]">
          <h2 className="mt-[8px] font-semibold sm:text-[20px] text-[18px] text-white">
            ...
            <p className="mt-[8px] font-semibold sm:text-[18px] text-[16px] text-white">{subtitle}</p>
          <p className="font-normal text-[13px] leading-[20.16px] text-white whitespace-pre-line ">
            {description}
          </p>
        </motion.div>
    </motion.div>
